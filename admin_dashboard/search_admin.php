...
<head>
    ...
    <title>Search Admin - Valley Clinic</title>
    <!-- bootstap -->
                    ...
                    <div class="card shadow mb-2">
                      <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-8">
                              <h6 class="pt-1 card-title">Admin</h6>
                            </div>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="card shadow bg-white rounded-3">
                      <div class="card-body m-4">
                        ...
                        <div class="row row-cols-4 justify-content-between align-items-center mb-5">
                          <div class="col-5">
                            <h5 class="card-title">Search Administrator Accounts</h5>
                          </div>
                        ...
                        <table id="search-admin" class="display table table-striped" style="width:100%">
                          <thead>
                              <tr>
                          ...
                          <tbody>
                          <?php
                            $query = "SELECT * FROM `tbl_admin_acc`";
