...
<head>
    ...
    <title>Search Doctor - Valley Clinic</title>
    <!-- bootstap -->
                    ...
                    <div class="card shadow bg-white rounded-3">
                      <div class="card-body m-4">
                        ...
                        <div class="row row-cols-4 justify-content-between align-items-center mb-5">
                          <div class="col-5">
                            <h5 class="card-title">Search Doctor Accounts</h5>
                          </div>
                          
                          <div class="col-3 text-end">
                            <a href="create_doctor.php">
                            <button type="button" class="btn btn-dark">New Account <i class="bi bi-plus-circle-fill ms-1"></i></button>
                            </a>
                          </div>
                        </div>
                        ...
                        <table id="search-doctor" class="display table table-striped" style="width:100%">
                        <thead>
                              <tr>
                              ...
                              <tr>
                                  <form action="delete_doctor.php" method="post">
                                    ...
                                    <td class="text-center" >
                                      <a href='view_doctor.php?DocID=<?php echo $row['DocID'] ?>&' class="text-decoration-none text-dark" target="_blank">
                                        <?php echo $row['Name'] ?>
                                      </a>
                                    </td>
                                    <td class="text-center" >
