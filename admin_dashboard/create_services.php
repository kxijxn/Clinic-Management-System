                  ...
                  <div class="col">
                    <div class="card shadow bg-white rounded-3">
                      <div class="card-body m-4">
                        ...
                        <form class="mx-5 vh-100" action="insert_services.php" method="POST" ENCTYPE="multipart/form-data">
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Description" style="height: 100px" name="Description" aria-label="Description" required></textarea>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Consultation Fee" name="Consultation_Fees" required>
                              ...
                              <option value="RM30 - RM5">RM30 - RM50</option>
                              <option value="RM51 - RM80">RM51 - RM80</option>
                              <option value="RM81 - RM125">RM81 - RM125</option>
                              <option value="RM126 - RM235">RM126 - RM235</option>
                            </select>
                          </div>
                          <div class="mb-3">
