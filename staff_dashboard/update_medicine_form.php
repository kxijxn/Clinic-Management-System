...
<head>
    ...
    <title>Update Medicine - Valley Clinic</title>
                    ...
                    <div class="card shadow bg-white rounded-3">
                      <div class="card-body m-4">
                        ...
                        <div class="row row-cols-4 justify-content-between align-items-center mb-5">
                          <div class="col-12">
                            <h5 class="card-title ms-5">Update Medicine</h5>
                          </div>
                        </div>
                        ...
                        <form class="mx-5 vh-100" action="update_medicine.php" method="post">
                          <input type="hidden" name="MedID" value="<?php echo $row['MedID'] ?>">

                          <div class="mb-3">
                            <label for="Title" class="form-label">Name</label>
                            <input class="form-control" type="text" placeholder="Title" name="Name" autocomplete="off" aria-label="Title"  value="<?php echo $row['Name'] ?>" required>
                          </div>
                          <div class="mb-3">
                            <label for="Description" class="form-label">Description</label>
                            <textarea class="form-control" placeholder="Description" name="Description" autocomplete="off" aria-label="Description"   style="height: 100px" required><?php echo $row['Description'] ?></textarea>
                          </div>
                          <div class="mb-3">
                            <label for="Specialist_category" class="form-label">Price</label>
                            <input class="form-control" type="text" placeholder="Price" name="Price" autocomplete="off" aria-label="Specialist Category" value="<?php echo $row['Price'] ?>" required>
                          </div>
                          <div class="mb-3">
                            <label for="Consultation_Fees" class="form-label">Quantity</label>
                            <input class="form-control" type="text" placeholder="Quantity" autocomplete="off" aria-label="Consultation Fee" name="Quantity" value="<?php echo $row['Quantity'] ?>" required>
                          </div>
                          <div class="d-grid">
